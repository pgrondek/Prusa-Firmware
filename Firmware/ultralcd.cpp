...
static void mFilamentItem_FIBERWOOD()
{
    bFilamentPreheatState = false;
    mFilamentItem(FIBERWOOD_PREHEAT_HOTEND_TEMP, FIBERWOOD_PREHEAT_HPB_TEMP);
}
...
void lcd_generic_preheat_menu()
{
    ...
    else
    {
        ...
        MENU_ITEM_SUBMENU_P(PSTR("WOOD -  " STRINGIFY(FIBERWOOD_PREHEAT_HOTEND_TEMP) "/" STRINGIFY(FIBERWOOD_PREHEAT_HPB_TEMP)),mFilamentItem_FIBERWOOD);
